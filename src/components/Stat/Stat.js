      ...
      <div id="stat1">
        <div id="statgroup1">
          <div className="groupcard">
            <div className="groupcard-head">
              50K<span className="spangreen">+</span>
            </div>
            <div className="groupcard-body">Mobile Downloads</div>
          </div>
          <div className="groupcard">
            <div className="groupcard-head">
              80K<span className="spangreen">+</span>
            </div>
        ...
        <div id="statgroup2">
          <div className="groupcard">
            <div className="groupcard-head">
              53K<span className="spangreen">+</span>
            </div>
            <div className="groupcard-body">Sessions per month</div>
          </div>
          <div className="groupcard">
            <div className="groupcard-head">
              200<span className="spangreen">+</span>
            </div>
